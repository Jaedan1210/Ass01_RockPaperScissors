import java.util.Scanner;
    public class RockPaperScissors {
        public static void main(String[] args) {
            ...
            do {
                String playerAChoice = getPlayerChoice(scanner, "1");
                String playerBChoice = getPlayerChoice(scanner, "2");
        ...
        private static String getPlayerChoice(Scanner scanner, String playerName) {
            ...
            do {
                ...
                choice = scanner.nextLine().trim().toUpperCase(); // Convert to uppercase for validation
